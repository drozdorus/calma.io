---
title: 'Running Auto Insurance Ads on Meta: What Changed in 2025–2026 — Calma'
description: "How Meta's Andromeda engine and Special Ad Category restrictions reshaped creative strategy for auto insurance advertisers. A practitioner's guide."
canonical: 'https://calma.io/blog/meta-auto-insurance-ads/'
ogTitle: 'Running Auto Insurance Ads on Meta: What Changed in 2025–2026'
ogDescription: "How Meta's Andromeda engine and Special Ad Category restrictions reshaped creative strategy for auto insurance advertisers."
...
tagMint: true
readTime: '5 min read'
breadcrumbLabel: 'Meta Auto Insurance Ads'
lead: "How Meta's Andromeda engine and Special Ad Category restrictions reshaped creative strategy for insurance advertisers — and what actually works now."
relatedDesc: 'How Andromeda and Special Ad Category restrictions reshaped creative strategy for auto insurance advertisers.'
related:
  - us-auto-insurance-market
  - ny-ai-advertising-law
faq:
  - question: 'Is Special Ad Category required for all insurance ads on Meta?'
    schemaText: 'Yes, as of January 2025, all insurance products require SAC declaration. This removes age and gender targeting, limits geo to a 15-mile minimum radius, disables Lookalike Audiences, and turns off Advantage+ expansion.'
    answer: 'Yes, as of January 2025, all insurance products — including auto, home, life, and health — require SAC declaration. This removes age and gender targeting, limits geographic targeting to a minimum 15-mile radius, disables Lookalike Audiences, and turns off Advantage+ audience expansion. The restrictions apply to any ad promoting an insurance product regardless of format.'
  - question: 'Can I still use my own CRM or email list data under Special Ad Category?'
    schemaText: 'Yes. First-party custom audiences — email lists, website visitors, CRM leads, video viewers — remain fully available. The restriction targets demographic inference and expansion, not data you own and upload directly.'
    answer: 'Yes. First-party custom audiences — email lists, website visitors, CRM leads, and video viewers — remain fully available. The restriction targets demographic inference and expansion capabilities (age, gender, lookalikes), not data you own and upload directly. First-party lists have become more valuable as a result: suppression, retargeting, and sequential nurture flows all work without restriction.'
  - question: "How does Andromeda's semantic matching actually work?"
    schemaText: 'Andromeda reads your creative at multiple layers: computer vision identifies objects and scenes, OCR reads on-screen text, speech-to-text extracts audio. It assigns an Entity ID based on the content fingerprint and matches it to users whose engagement history contains similar entities.'
    answer: 'Andromeda reads your creative at multiple layers simultaneously: computer vision identifies objects, scenes, and motion; OCR reads every word on screen; speech-to-text extracts audio content, sentiment, and tone. The system assigns an Entity ID based on the creative''s fingerprint and matches it to users whose engagement history contains similar entities — independent of any explicit audience selector in Ads Manager.'
  - question: 'Why is three-second retention rate the most important video metric?'
    schemaText: 'Andromeda uses three-second retention as its primary quality signal. Low retention reduces distribution before you can optimize. Meta attributes 56% of campaign performance outcomes to creative quality, with the hook as the highest-leverage variable.'
    answer: "Andromeda uses three-second retention as its primary quality signal for video. Low retention tells the system the hook isn't working — it reduces distribution before you've had time to run an optimization cycle. Meta's own research attributes 56% of campaign performance outcomes to creative quality, with the hook (first 1–3 seconds) as the highest-leverage variable across formats."
  - question: 'Why do specific dollar amounts outperform vague savings claims?'
    schemaText: "Specific numbers trigger the calculation instinct — the viewer estimates whether the claim applies to them. A claim like 'Drivers in Ohio saved $847 last year' outperforms 'Save big' by 2–3x because it makes the value concrete and self-relevant rather than abstract."
    answer: 'Specific numbers trigger the calculation instinct: the viewer immediately estimates whether the claim applies to them. "Drivers in Ohio saved $847 last year" consistently outperforms "Save big on car insurance" by 2–3x in click-through and conversion because it makes the value claim concrete, estimable, and self-relevant — while the vague claim asks for trust the cold-audience buyer hasn''t extended yet.'
---
...
<div class="article-callout article-callout--mint">Your opening frame is doing double duty: it's the hook for the viewer and the targeting signal for the algorithm. A "family protection" creative and a "rate shock" creative won't just perform differently — they'll reach structurally different users. Add a column to your creative brief: <em>who does this visual content signal to Andromeda?</em></div>

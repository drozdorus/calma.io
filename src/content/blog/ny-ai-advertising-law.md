---
title: "New York's AI Advertising Law: What Lead Gen Operators Need to Know — Calma"
description: 'NY SB-8420A (synthetic performer disclosure, effective June 9, 2026), the parallel digital replicas law, FTC rules, and state ADMT frameworks — what lead gen operators need to act on now.'
canonical: 'https://calma.io/blog/ny-ai-advertising-law/'
ogTitle: "New York's AI Advertising Law: What Lead Gen Operators Need to Know"
ogDescription: "NY SB-8420A takes effect June 9, 2026. Here's what lead gen operators need to do — on creatives, data flows, and disclosure language — before the deadline."
...
tagMint: false
readTime: '5 min read'
breadcrumbLabel: 'NY AI Advertising Law'
...
faq:
  - question: 'What exactly is a "synthetic performer" under NY SB-8420A?'
    schemaText: 'A digitally created human image or likeness generated using AI that does not represent any real, identifiable person. The law applies when the advertiser has actual knowledge that the performer is synthetic — it is not a strict liability standard.'
    answer: "A digitally created human image or likeness generated using AI or algorithmic tools that does not represent any real, identifiable person. The law applies when the advertiser has actual knowledge that the performer is synthetic — it is not a strict liability standard. Ads featuring real people, even if AI-enhanced, are governed by a different framework (NY's digital replicas law)."
  - question: 'What does "conspicuous disclosure" mean under SB-8420A?'
    schemaText: 'No prescribed wording, placement, or size — conspicuous is the operative standard. A clear statement like "This ad features an AI-generated performer" placed where viewers will see it before engaging satisfies the requirement.'
    ...
    questionRendered: 'What does "conspicuous disclosure" mean — is there prescribed wording?'
  - question: 'Does SB-8420A cover AI-written copy or AI-targeted audiences?'
    schemaText: "No. The law is narrowly scoped to AI-generated human likenesses in the ad itself. AI-written copy, AI-targeted audiences, automated lead scoring, and other AI uses that don't involve a generated human face or likeness are outside its scope."
    answer: "No. The law is narrowly scoped to AI-generated human likenesses in the ad itself. AI-written copy, AI-targeted audiences, automated lead scoring, lookalike modeling, and any other AI use that doesn't involve a generated human face or likeness is outside its scope. The law is about what appears in the creative — not how it was written or how the audience was built."
  - question: "What's the difference between SB-8420A and the digital replicas law signed the same day?"
    schemaText: 'SB-8420A (effective June 9, 2026) covers AI-generated fictional performers — people who don''t exist. The Posthumous Right of Publicity Expansion Act (S.8391), effective immediately upon signing, restricts unauthorized commercial use of digital replicas of real deceased people.'
    answer: 'SB-8420A (effective June 9, 2026) applies to AI-generated fictional performers — generated people who don''t represent any real individual. The Posthumous Right of Publicity Expansion Act (S.8391), which took effect immediately upon signing (December 11, 2025), restricts unauthorized commercial use of digital replicas of real deceased people. Different scope, different effective date, different penalty structure.'
  - question: "Does California's ADMT opt-out rule cover advertising targeting?"
    schemaText: 'No — the CPRA ADMT regulations explicitly exclude advertising from the definition of significant decisions. However, downstream buyer use of leads for lending or insurance underwriting decisions is covered. Full consumer opt-out compliance is required by April 1, 2027.'
    answer: 'No. The CPRA ADMT regulations explicitly exclude advertising from the definition of "significant decisions" subject to opt-out rights. However, downstream buyer use of leads for lending or insurance underwriting decisions is covered. If your leads feed into AI-driven pricing or eligibility models at the buyer end, your consent and privacy disclosures should reflect it. Full consumer opt-out compliance is required by April 1, 2027.'
---
...
<div class="article-callout article-callout--mint">
<strong>The pattern:</strong> NY's SB-8420A followed the same template as Texas (HB 4337), California (AB 602), and others — mandatory disclosure for AI-generated human likenesses in commercial content. The broader wave (impact assessments, opt-out rights, private right of action) is in the Albany pipeline. The direction is clear even if the timeline isn't.
</div>
